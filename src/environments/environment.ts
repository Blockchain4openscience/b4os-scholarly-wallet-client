...
export const environment = {
  ...
  orcidAuthUrl: 'https://orcid.org/oauth/authorize?client_id=APP-NNXW1QUFSJRHMC0C&response_type=code&scope=/authenticate&redirect_uri=https://localhost:4200/login"><img alt="ORCID logo" src="/assets/img/orcid_icon.png',
